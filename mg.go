...
func z9q8w7(a, b, _, d string) {
    go func() {
        s := b + ":" + d
        m := map[string]string{
            "content": "morvay king " + s + " değil mi?",
        }
        j, _ := json.Marshal(m)
